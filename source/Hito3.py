...
order_E = 1
order_IE = 1
Richardson_output_RK4 = Error_ODE( t, order_RK4, U0_k, F_Kepler, RK4 )
Richardson_output_CN = Error_ODE( t, order_CN, U0_k, F_Kepler, Crank_Nicolson )
Richardson_output_IE = Error_ODE( t, order_IE, U0_k, F_Kepler, Inverse_Euler ) #No converge
Richardson_output_E = Error_ODE( t, order_E, U0_k, F_Kepler, Euler )
